    ...
    <>
      <div className="bg" style={{marginTop: "2px", marginBottom: "-76px"}}>
        ...
        <div className="hero-text" style={{transform: "translateY(-60px)"}}>
            ...
            <div className="dtlo-wrapper" style={{backgroundImage: "url('/images/icons/icon_time.png')"}}>
                <h2>Horário</h2>
                <p>16h30min</p>
            </div>

            <div className="dtlo-wrapper" style={{backgroundImage: "url('/images/icons/icon_location.png')"}}>
                <h2>Local</h2>
                <p>Rua Alfazema, 8</p>
            </div>

            <img src="/images/local.png" className="local-icon" />
