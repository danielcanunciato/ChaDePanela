        ...
        <div className="bg" style={{ marginBottom: "-40px" }}>
          <div className="hero2-text" style={{ transform: "scale(.85)" }}>
            ...
            <p style={{ fontSize: "1.1rem" }}>
              ...
              usar a chave pix que está logo abaixo.
            </p>
            ...
            <div className="qrcode-wrapper">
              <div className="chave-pix">
                <p>
                  ...
                  <span style={{ fontSize: "1.2rem" }}>11 978877392</span>{" "}
                  <br />
                  <span style={{ fontSize: ".9rem" }}>
                    Daniel Camilo Anunciato de Oliveira
                  </span>{" "}
                  <br />
                  <br />
                  <span style={{ fontSize: "1.2rem" }}>11 983049632</span>{" "}
                  <br />
                  <span style={{ fontSize: ".9rem" }}>
